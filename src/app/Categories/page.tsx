...
export default function Categories() {
  const [categories, setCategories] = useState<categorise[]>([]);
  ...
  return (
    <div className="max-w-6xl mx-auto mt-12 px-4">
      ...
      <div className="flex justify-between items-center mb-10">
        <h1 className="text-4xl font-extrabold bg-gradient-to-r from-indigo-600 via-pink-500 to-purple-600 bg-clip-text text-transparent">
